  ...
  if (marta == 0) {
    ...
    if (s == 0) {
      document.getElementById("demo").innerHTML =
        marta + " ta random massive kirgizilganda masala yechimi topilmadi ";
    } else {
      document.getElementById("demo").innerHTML =
        marta +
        " ta random massive kirgizilganda " +
        s +
        " marta masala yechimini topdi ";
    }
    document.getElementById("demo1").innerHTML =
      "Natija:   " + "   " + s / (marta / 100) + " %";
    document.getElementById("demo2").innerHTML =
      "Saytni refresh qilib yuboring";
  }
